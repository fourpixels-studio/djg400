...
from .views import mix_list, audio_mix_detail, filtered_genres, filtered_albums, video_mix_list, video_mix_detail
from .utils import like_mix, reshare_mix

urlpatterns = [
    path("", mix_list, name="mix_list"),
    path("audio/<slug:slug>/", audio_mix_detail, name="audio_mix_detail"),
